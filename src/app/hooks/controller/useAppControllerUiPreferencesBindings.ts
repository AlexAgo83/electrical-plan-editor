...
export function useAppControllerUiPreferencesBindings({
  ...
  useUiPreferences({
    ...
    tabularExportFormat: preferencesState.tabularExportFormat,
    bomExportCompactColumns: preferencesState.bomExportCompactColumns,
    bomTraceabilityLabelsHidden: preferencesState.bomTraceabilityLabelsHidden,
    ...
    spliceSectionImbalanceRatioPercent: preferencesState.spliceSectionImbalanceRatioPercent,
    ...
    canvasDefaultCalloutContentMode: preferencesState.canvasDefaultCalloutContentMode,
    ...
    canvasCalloutConnectorDrawingScalePercent: preferencesState.canvasCalloutConnectorDrawingScalePercent,
    ...
    restoreViewportOnUndo: preferencesState.restoreViewportOnUndo,
    ...
    setTabularExportFormat: preferencesState.setTabularExportFormat,
    setBomExportCompactColumns: preferencesState.setBomExportCompactColumns,
    ...
    setSpliceSectionImbalanceRatioPercent: preferencesState.setSpliceSectionImbalanceRatioPercent,
    ...
    setCanvasCalloutConnectorDrawingScalePercent: preferencesState.setCanvasCalloutConnectorDrawingScalePercent,
