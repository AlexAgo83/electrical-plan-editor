...
export function useAppControllerModelingHandlersAssembly({
  ...
  return useAppControllerModelingHandlersOrchestrator({
    ...
    setSplicePlacementSegmentId: formsState.setSplicePlacementSegmentId,
    splicePlacementFromNodeId: formsState.splicePlacementFromNodeId,
    setSplicePlacementFromNodeId: formsState.setSplicePlacementFromNodeId,
    splicePlacementOffsetMm: formsState.splicePlacementOffsetMm,
    setSplicePlacementOffsetMm: formsState.setSplicePlacementOffsetMm,
    ...
    setWireEndpointAAllowSharedCavity: formsState.setWireEndpointAAllowSharedCavity,
    ...
    setWireEndpointBAllowSharedCavity: formsState.setWireEndpointBAllowSharedCavity,
