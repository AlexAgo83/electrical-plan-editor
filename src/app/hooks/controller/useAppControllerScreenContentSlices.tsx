...
export function buildModelingScreenContentSlice(params: ModelingScreenContentSliceParams) {
  ...
  const modelingSecondaryTablesProps = {
    ...
    wireTwistGroupFilter: params.wireTwistGroupFilter,
    setWireTwistGroupFilter: params.setWireTwistGroupFilter,
    wireTwistGroupOptions: params.wireTwistGroupOptions,
...
export function buildSettingsScreenContentSlice(params: SettingsScreenContentSliceParams) {
  const settingsWorkspaceContentProps = {
    ...
    canvasExportFormat: params.canvasExportFormat,
    setCanvasExportFormat: params.setCanvasExportFormat,
