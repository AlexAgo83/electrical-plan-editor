...
export function buildAppControllerNamespacedFormsState(forms: AppControllerFormsStateFlat) {
  return {
    connector: {
      ...
      rearBackshellOverrideEnabled: forms.connectorRearBackshellOverrideEnabled,
      setRearBackshellOverrideEnabled: forms.setConnectorRearBackshellOverrideEnabled,
      rearBackshellOverrideLengthMm: forms.connectorRearBackshellOverrideLengthMm,
      setRearBackshellOverrideLengthMm: forms.setConnectorRearBackshellOverrideLengthMm,
    ...
    splice: {
      ...
      portMode: forms.splicePortMode,
      setPortMode: forms.setSplicePortMode,
      sideInverted: forms.spliceSideInverted,
      setSideInverted: forms.setSpliceSideInverted,
      ...
      formInfo: forms.spliceFormInfo,
      setFormInfo: forms.setSpliceFormInfo,
    ...
    segment: {
      ...
      sheathType: forms.segmentSheathType,
      setSheathType: forms.setSegmentSheathType,
      insulation: forms.segmentInsulation,
      setInsulation: forms.setSegmentInsulation,
      lineStyle: forms.segmentLineStyle,
      setLineStyle: forms.setSegmentLineStyle,
      internalPartReference: forms.segmentInternalPartReference,
      setInternalPartReference: forms.setSegmentInternalPartReference,
      mountingLabelsText: forms.segmentMountingLabelsText,
      setMountingLabelsText: forms.setSegmentMountingLabelsText,
    ...
    wire: {
      ...
      setMaterial: forms.setWireMaterial,
      ...
      endpointASpliceSideOverride: forms.wireEndpointASpliceSideOverride,
      setEndpointASpliceSideOverride: forms.setWireEndpointASpliceSideOverride,
      endpointASpliceSideLocked: forms.wireEndpointASpliceSideLocked,
      setEndpointASpliceSideLocked: forms.setWireEndpointASpliceSideLocked,
      ...
      endpointBSpliceSideOverride: forms.wireEndpointBSpliceSideOverride,
      setEndpointBSpliceSideOverride: forms.setWireEndpointBSpliceSideOverride,
      endpointBSpliceSideLocked: forms.wireEndpointBSpliceSideLocked,
      setEndpointBSpliceSideLocked: forms.setWireEndpointBSpliceSideLocked,
