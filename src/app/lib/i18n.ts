...
const FR_TEXT_BY_EN_TEXT: Readonly<Record<string, string>> = {
  ...
  "Ports": "Ports",
  "Branches": "Branches",
  "Connected wires": "Fils connectés",
  "Occup.": "Occup.",
  "Go to": "Aller à",
  ...
  "Default auto-create linked nodes for connectors": "Auto-création de nœuds liés par défaut pour connecteurs",
  ...
  "Recompute routes": "Recalculer les trajets",
  "Recompute all wire routes and splice sides for this network": "Recalculer tous les trajets de fils et côtés d'épissures de ce réseau",
  "Recompute report": "Rapport de recalcul",
  "All wire routes and directional splice sides were recomputed. No changes were needed.": "Tous les trajets de fils et côtés d'épissures directionnelles ont été recalculés. Aucune modification nécessaire.",
  ...
  "Suggest optimized lengths": "Suggérer des longueurs optimisées",
  "Suggested splice lengths": "Longueurs d'épissure suggérées",
  "No optimized lengths": "Aucune longueur optimisée",
  "Apply suggestion": "Appliquer la suggestion",
  "Optimized lengths applied": "Longueurs optimisées appliquées",
  "Optimized lengths failed": "Échec de l'optimisation des longueurs",
  "Optimized splice lengths applied.": "Longueurs optimisées de l'épissure appliquées.",
  "Review the optimized segment lengths before applying them.": "Vérifiez les longueurs de segments optimisées avant de les appliquer.",
  "No better lengths found within current constraints.": "Aucune meilleure longueur trouvée avec les contraintes actuelles.",
  ...
  "lengths optimized": "longueurs optimisées",
