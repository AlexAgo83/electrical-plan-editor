...
export function buildNetworkSummaryPanelControllerSlice(
  ...
  const networkSummaryPanelProps = {
    ...
    showColocatedSpliceLinkLine: params.showColocatedSpliceLinkLine,
    showNetworkEntityPrefix: params.showNetworkEntityPrefix,
    calloutContentMode: params.networkCalloutContentMode,
    showSelectedCalloutOnly: params.showSelectedCalloutOnly,
    connectorDrawingDisplayMode: params.connectorDrawingDisplayMode,
    useConsistentConnectorLayoutScale: params.useConsistentConnectorLayoutScale,
    connectorDrawingScalePercent: params.connectorDrawingScalePercent,
    globalRenderScalePercent: params.globalRenderScalePercent,
    setGlobalRenderScalePercent: params.setGlobalRenderScalePercent,
    ...
    showCalloutWireNames: params.showCalloutWireNames,
    zoomInvariantNodeShapes: params.zoomInvariantNodeShapes,
    ...
    setExportIncludeCartouche: params.setExportIncludeCartouche,
    exportCartoucheNetworkName: params.exportCartoucheNetworkName,
    exportCartoucheAuthor: params.exportCartoucheAuthor,
    exportCartoucheProjectCode: params.exportCartoucheProjectCode,
...
export function buildNetworkScopeScreenContentSlice(
  ...
  const networkScopeWorkspaceProps = {
    ...
    newNetworkCreatedAtDate: params.newNetworkCreatedAtDate,
    setNewNetworkCreatedAtDate: params.setNewNetworkCreatedAtDate,
    newNetworkDescription: params.newNetworkDescription,
    setNewNetworkDescription: params.setNewNetworkDescription,
    newNetworkAuthor: params.newNetworkAuthor,
    setNewNetworkAuthor: params.setNewNetworkAuthor,
    newNetworkVoltageV: params.newNetworkVoltageV,
    setNewNetworkVoltageV: params.setNewNetworkVoltageV,
    newNetworkProjectCode: params.newNetworkProjectCode,
    setNewNetworkProjectCode: params.setNewNetworkProjectCode,
    newNetworkEntityPrefix: params.newNetworkEntityPrefix,
    setNewNetworkEntityPrefix: params.setNewNetworkEntityPrefix,
    newNetworkLogoUrl: params.newNetworkLogoUrl,
    setNewNetworkLogoUrl: params.setNewNetworkLogoUrl,
    newNetworkExportNotes: params.newNetworkExportNotes,
    setNewNetworkExportNotes: params.setNewNetworkExportNotes,
...
export function buildModelingScreenContentSlice(
  ...
  const modelingPrimaryTablesProps = {
    ...
    tableColumnPreferences: params.tableColumnPreferences,
    setTableColumnPreferences: params.setTableColumnPreferences,
  ...
  const modelingSecondaryTablesProps = {
    ...
    wireFunctionalTagFilter: params.wireFunctionalTagFilter,
    setWireFunctionalTagFilter: params.setWireFunctionalTagFilter,
    wireFunctionalTagOptions: params.wireFunctionalTagOptions,
  ...
  const modelingFormsColumnProps = {
    ...
    splicePortMode: params.splicePortMode,
    setSplicePortMode: params.setSplicePortMode,
    spliceSideInverted: params.spliceSideInverted,
    setSpliceSideInverted: params.setSpliceSideInverted,
    ...
    splicePlacementSegmentId: params.splicePlacementSegmentId,
    setSplicePlacementSegmentId: params.setSplicePlacementSegmentId,
    splicePlacementFromNodeId: params.splicePlacementFromNodeId,
    setSplicePlacementFromNodeId: params.setSplicePlacementFromNodeId,
    splicePlacementOffsetMm: params.splicePlacementOffsetMm,
    setSplicePlacementOffsetMm: params.setSplicePlacementOffsetMm,
    ...
    spliceFormInfo: params.spliceFormInfo,
    ...
    segmentSheathType: params.segmentSheathType,
    setSegmentSheathType: params.setSegmentSheathType,
    segmentInsulation: params.segmentInsulation,
    setSegmentInsulation: params.setSegmentInsulation,
    segmentLineStyle: params.segmentLineStyle,
    setSegmentLineStyle: params.setSegmentLineStyle,
    segmentInternalPartReference: params.segmentInternalPartReference,
    setSegmentInternalPartReference: params.setSegmentInternalPartReference,
    segmentMountingLabelsText: params.segmentMountingLabelsText,
    setSegmentMountingLabelsText: params.setSegmentMountingLabelsText,
    ...
    setWireCurrentA: params.setWireCurrentA,
    wireMaterial: params.wireMaterial,
    setWireMaterial: params.setWireMaterial,
    recommendedWireSectionMm2: params.recommendedWireSectionMm2,
    handleApplyRecommendedWireSection: params.handleApplyRecommendedWireSection,
    ...
    wireFuseEnabled: params.wireFuseEnabled,
    setWireFuseEnabled: params.setWireFuseEnabled,
    wireFuseCatalogItemId: params.wireFuseCatalogItemId,
    ...
    wireEndpointASealName: params.wireEndpointASealName,
    setWireEndpointASealName: params.setWireEndpointASealName,
    ...
    wireEndpointBSealName: params.wireEndpointBSealName,
    setWireEndpointBSealName: params.setWireEndpointBSealName,
...
export function buildAnalysisScreenContentSlice(
  ...
  const analysisWorkspaceContentProps = {
    ...
    spliceAnalysisView: params.spliceAnalysisView,
    setSpliceAnalysisView: params.setSpliceAnalysisView,
    nodeKindFilter: params.nodeKindFilter,
    setNodeKindFilter: params.setNodeKindFilter,
    nodeFilterField: params.nodeFilterField,
    setNodeFilterField: params.setNodeFilterField,
...
export function buildSettingsScreenContentSlice(
  ...
  const settingsWorkspaceContentProps = {
    ...
    setCanvasZoomInvariantNodeShapes: params.setCanvasZoomInvariantNodeShapes,
    canvasShowColocatedSpliceLinkLine: params.canvasShowColocatedSpliceLinkLine,
    setCanvasShowColocatedSpliceLinkLine: params.setCanvasShowColocatedSpliceLinkLine,
    canvasShowNetworkEntityPrefix: params.canvasShowNetworkEntityPrefix,
    setCanvasShowNetworkEntityPrefix: params.setCanvasShowNetworkEntityPrefix,
    ...
    setCanvasExportIncludeCartouche: params.setCanvasExportIncludeCartouche,
    ...
    canvasResizeBehaviorMode: params.canvasResizeBehaviorMode,
    setCanvasResizeBehaviorMode: params.setCanvasResizeBehaviorMode,
    ...
    saveWorkspaceFileNow: params.saveWorkspaceFileNow,
