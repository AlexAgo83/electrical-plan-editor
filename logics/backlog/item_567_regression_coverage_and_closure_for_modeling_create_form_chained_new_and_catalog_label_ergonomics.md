## item_567_regression_coverage_and_closure_for_modeling_create_form_chained_new_and_catalog_label_ergonomics - Regression coverage and closure for modeling create-form chained New and catalog label ergonomics
> From version: 1.4.4
> Schema version: 1.0
> Status: Done
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|regression-coverage-and-closure-for-mode|req-051-catalog-screen-with-catalog-item|in-connector-and-splice-create-edit|ac1-connector-and-splice-catalog-selecto
flowchart LR
    Request[req_114_connector_and_splice_catalog_label] --> Problem[In connector and splice create edit]
    Problem --> Scope[Regression coverage and closure for modeli]
