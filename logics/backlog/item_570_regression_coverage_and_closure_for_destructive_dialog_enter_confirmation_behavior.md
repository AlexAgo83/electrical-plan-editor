...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|regression-coverage-and-closure-for-dest|req-074-all-delete-actions-require-style|repetitive-delete-flows-are-slower-than|ac1-in-scope-delete-confirmation-dialogs
flowchart LR
    Request[req_115_keyboard_confirmation_shortcut_for] --> Problem[Repetitive delete flows are slower than]
    Problem --> Scope[Regression coverage and closure for destru]
