...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|connector-and-splice-catalog-selector-la|req-051-catalog-screen-with-catalog-item|in-connector-and-splice-create-edit|ac1-connector-and-splice-catalog-selecto
flowchart LR
    Request[req_114_connector_and_splice_catalog_label] --> Problem[In connector and splice create edit]
    Problem --> Scope[Connector and splice catalog selector labe]
