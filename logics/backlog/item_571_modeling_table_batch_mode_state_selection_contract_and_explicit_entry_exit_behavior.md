...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|modeling-table-batch-mode-state-selectio|req-074-all-delete-actions-require-style|users-want-to-delete-several-modeling|ac1-modeling-tables-support-an-explicit
flowchart LR
    Request[req_116_batch_delete_mode_for_modeling_tab] --> Problem[Users want to delete several modeling]
    Problem --> Scope[Modeling table batch mode state selection]
