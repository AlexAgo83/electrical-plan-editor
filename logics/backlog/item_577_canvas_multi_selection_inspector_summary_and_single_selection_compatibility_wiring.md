## item_577_canvas_multi_selection_inspector_summary_and_single_selection_compatibility_wiring - Canvas multi selection inspector summary and single selection compatibility wiring
> From version: 1.4.4
> Schema version: 1.0
> Status: Done
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|canvas-multi-selection-inspector-summary|req-109-new-and-edit-actions-scroll-to-c|users-want-to-manipulate-several-element|ac1-on-the-2d-modeling-canvas
flowchart LR
    Request[req_117_shift_click_multi_selection_and_gr] --> Problem[Users want to manipulate several elements]
    Problem --> Scope[Canvas multi selection inspector summary a]
