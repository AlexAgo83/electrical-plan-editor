## item_574_regression_coverage_and_closure_for_modeling_table_batch_delete_flows - Regression coverage and closure for modeling table batch delete flows
> From version: 1.4.4
> Schema version: 1.0
> Status: Done
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|regression-coverage-and-closure-for-mode|req-074-all-delete-actions-require-style|users-want-to-delete-several-modeling|ac1-modeling-tables-support-an-explicit
flowchart LR
