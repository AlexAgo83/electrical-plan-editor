## item_568_delete_and_cascade_delete_dialog_enter_shortcut_contract_with_cancel_focused_safety - Delete and cascade delete dialog Enter shortcut contract with cancel-focused safety
> From version: 1.4.4
> Schema version: 1.0
> Status: Ready
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|delete-and-cascade-delete-dialog-enter-s|req-074-all-delete-actions-require-style|repetitive-delete-flows-are-slower-than|ac1-in-scope-delete-confirmation-dialogs
flowchart LR
    Request[req_115_keyboard_confirmation_shortcut_for] --> Problem[Repetitive delete flows are slower than]
    Problem --> Scope[Delete and cascade delete dialog Enter]
