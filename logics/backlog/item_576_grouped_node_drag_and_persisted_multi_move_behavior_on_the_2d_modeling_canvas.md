...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|grouped-node-drag-and-persisted-multi-mo|req-109-new-and-edit-actions-scroll-to-c|users-want-to-manipulate-several-element|ac1-on-the-2d-modeling-canvas
flowchart LR
    Request[req_117_shift_click_multi_selection_and_gr] --> Problem[Users want to manipulate several elements]
    Problem --> Scope[Grouped node drag and persisted multi]
