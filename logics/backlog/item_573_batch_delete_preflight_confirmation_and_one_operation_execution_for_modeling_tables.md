## item_573_batch_delete_preflight_confirmation_and_one_operation_execution_for_modeling_tables - Batch delete preflight confirmation and one operation execution for modeling tables
> From version: 1.4.4
> Schema version: 1.0
> Status: Done
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|batch-delete-preflight-confirmation-and-|req-074-all-delete-actions-require-style|users-want-to-delete-several-modeling|ac1-modeling-tables-support-an-explicit
flowchart LR
    Request[req_116_batch_delete_mode_for_modeling_tab] --> Problem[Users want to delete several modeling]
    Problem --> Scope[Batch delete preflight confirmation and on]
