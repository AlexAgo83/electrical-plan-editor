...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|regression-coverage-and-closure-for-canv|req-109-new-and-edit-actions-scroll-to-c|users-want-to-manipulate-several-element|ac1-on-the-2d-modeling-canvas
flowchart LR
    Request[req_117_shift_click_multi_selection_and_gr] --> Problem[Users want to manipulate several elements]
    Problem --> Scope[Regression coverage and closure for canvas]
