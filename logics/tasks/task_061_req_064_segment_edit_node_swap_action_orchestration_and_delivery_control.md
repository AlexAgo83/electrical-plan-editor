...
```mermaid
%% logics-kind: task
%% logics-signature: task|req-064-segment-edit-node-swap-action-or|item-355-segment-edit-form-node-swap-sta|1-implement-segment-edit-node-swap|python3-logics-skills-logics-doc-linter-
flowchart TD
