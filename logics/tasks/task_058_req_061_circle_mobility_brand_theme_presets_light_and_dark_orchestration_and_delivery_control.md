...
```mermaid
%% logics-kind: task
%% logics-signature: task|req-061-circle-mobility-brand-theme-pres|item-345-circle-mobility-theme-mode-cont|1-add-circle-mobility-theme-mode|python3-logics-skills-logics-doc-linter-
flowchart TD
