...
```mermaid
%% logics-kind: task
%% logics-signature: task|req-063-wire-edit-endpoint-swap-action-o|item-352-wire-edit-form-endpoint-swap-st|1-implement-wire-edit-endpoint-swap|python3-logics-skills-logics-doc-linter-
flowchart TD
