...
```mermaid
%% logics-kind: task
%% logics-signature: task|req-074-all-delete-actions-require-style|item-383-delete-confirmation-orchestrati|1-deliver-wave-0-handler-orchestration|python3-logics-skills-logics-doc-linter-
flowchart TD
