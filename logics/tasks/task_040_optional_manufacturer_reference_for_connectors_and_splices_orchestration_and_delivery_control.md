...
```mermaid
%% logics-kind: task
%% logics-signature: task|optional-manufacturer-reference-for-conn|item-240-connector-splice-manufacturer-r|1-deliver-wave-0-connector-splice|documentation-logics
flowchart TD
