...
```mermaid
%% logics-kind: task
%% logics-signature: task|network-scope-workspace-shell-and-global|item-055-network-scope-screen-and-primar|1-deliver-wave-0-navigation-foundation|python3-logics-skills-logics-doc-linter-
flowchart TD
