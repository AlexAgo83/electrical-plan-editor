...
```mermaid
%% logics-kind: task
%% logics-signature: task|req-066-global-undo-redo-history-orchest|item-361-workspace-history-snapshot-cont|1-implement-history-foundation-for-works|python3-logics-skills-logics-doc-linter-
flowchart TD
