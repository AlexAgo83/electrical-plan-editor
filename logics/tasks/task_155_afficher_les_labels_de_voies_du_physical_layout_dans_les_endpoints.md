## task_155_afficher_les_labels_de_voies_du_physical_layout_dans_les_endpoints - Afficher les labels de voies du physical layout dans les endpoints
> From version: 1.17.1
> Schema version: 1.0
> Status: Done
> Understanding: 95%
...
- Run `logics-manager flow validate req_160_physical_layout_way_labels_in_endpoints item_646_afficher_les_labels_de_voies_du_physical_layout_dans_les_endpoints task_155_afficher_les_labels_de_voies_du_physical_layout_dans_les_endpoints --format json`.
...
- Linked backlog item(s): `item_646_afficher_les_labels_de_voies_du_physical_layout_dans_les_endpoints`
