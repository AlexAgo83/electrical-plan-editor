...
```mermaid
%% logics-kind: task
%% logics-signature: task|wire-cable-section-mm2-field-default-pre|item-230-wire-entity-section-mm2-field-a|1-deliver-wave-0-wire-domain|documentation-logics
flowchart TD
