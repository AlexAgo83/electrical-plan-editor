...
```mermaid
%% logics-kind: task
%% logics-signature: task|super-orchestration-delivery-execution-f|item-364-regression-coverage-for-global-|step-1-deliver-task-060-req-063-wire|run-the-relevant-automated-tests-before
flowchart TD
