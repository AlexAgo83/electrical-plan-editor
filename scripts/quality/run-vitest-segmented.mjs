...
const UI_LANE_TEST_FILES = [
  ...
  "src/tests/app.ui.batch-selection-dialog.spec.tsx",
  ...
  "src/tests/app.ui.creation-flow-wire-ergonomics.spec.tsx",
  "src/tests/app.ui.creation-flow-wire-endpoint-renames.spec.tsx",
  "src/tests/app.ui.creation-flow-wire-endpoint-refs.spec.tsx",
  "src/tests/app.ui.delete-confirmations.spec.tsx",
  "src/tests/app.ui.floating-splice-click-to-edit.spec.tsx",
  "src/tests/app.ui.form-validation-doctrine.spec.tsx",
  "src/tests/app.ui.functional-schematic-electrical-overlay.spec.tsx",
  "src/tests/app.ui.grouped-bom-wire-list.spec.tsx",
  ...
  "src/tests/app.ui.network-summary-bom-csv-export.spec.tsx",
  "src/tests/app.ui.network-summary-callouts-viewport.spec.tsx",
  "src/tests/app.ui.network-summary-layering.spec.tsx",
  "src/tests/app.ui.network-summary-svg-cartouche-export.spec.tsx",
  "src/tests/app.ui.network-summary-svg-export.spec.tsx",
  "src/tests/app.ui.network-summary-svg-preview.spec.tsx",
  "src/tests/app.ui.network-summary-viewport-persistence.spec.tsx",
  ...
  "src/tests/app.ui.render-containment.spec.tsx",
  ...
  "src/tests/app.ui.settings-ai-agent.spec.tsx",
  ...
  "src/tests/app.ui.statistics.spec.tsx",
